...
export abstract class AgentDialog<T extends IAgentDialogData> {
	...
	private static readonly OkButtonText: string = localize('newDatabaseDialog.OK', "OK");
	private static readonly CancelButtonText: string = localize('newDatabaseDialog.Cancel', "Cancel");
